...
namespace Probytech\Proadmin\Generators\Models;

use Probytech\Proadmin\Generators\Models\Relations\BelongsTo;
use Probytech\Proadmin\Generators\Models\Relations\BelongsToMany;
use Probytech\Proadmin\Generators\Models\Relations\HasMany;
...
class ModelGenerator
{
    ...
    {
        $uses = [
            'use Probytech\Proadmin\Models\MultilanguageModel;',
        ];
        ...
        foreach ($fields as $field) {
            ...
            if (in_array($field->type, ['password'])) {
                ...
                if ($field->relationship_count == 'single') {
                    ...
                    $fillableFields[] = "'".$field->relationship_table_name."_id'";
