...
class CollectionService
{
	...
	{
        $jsonMenu = json_decode(file_get_contents(storage_path('proadmin/collections.json')), true) ?? [];
    ...
    protected function save()
    {
        ...
        file_put_contents(storage_path('proadmin/collections.json'), json_encode($this->menu->toArray(), JSON_PRETTY_PRINT));
    }
}
