...
class ApiService
{
	...
	{
		$model = new $this->collectionItem->model;
	...
	public function store($data)
	{
		...
		$modelClass = $this->collectionItem->model;

		if ($this->collectionItem->multilanguage) {
	...
	{
		$fields = $this->collectionItem->getFieldsType();
	...
	{
		$visible = $this->collectionItem->getVisibleFields();
	...
	{
		$relations = $this->collectionItem->getRelations();
	...
	{
		$fieldsTypes = $this->collectionItem->getFieldsType();
