...
namespace App\Proadmin\Exports;
        ...
        foreach (json_decode($this->collection->fields) as $field) {
            ...
            if ($field->type != 'relationship') {
                ...
                if ($field->relationship_count == 'single') {
                    ...
                    $joins[] = [$relationshipTable.' as '.$relationshipTableOther, $relationshipTableOther.'.id', $this->table.'.id_'.$field->relationship_table_name];
                }
            }
        }
