...
namespace App\Proadmin\Commands;

use Illuminate\Console\Command;
use App\Proadmin\Helpers\Translater;
...
class ProadminTranslate extends Command
{
	/**
	 ...
	 * @var string
	 */
	protected $signature = 'proadmin:translate {argument?}';
	 ...
	 * @var string
	 */
	protected $description = 'Translate language of Proadmin.';
