<template id="template-single">
	<div class="table-edit">
		<h1>{{__('proadmin.gen_single_desc')}}</h1>
		<div class="menu-table">
			<div class="form-group">
				<label class="menu-item-title">{{__('proadmin.gen_single_item')}}</label>
			...
			<div class="form-group">
				<label class="menu-item-title">{{__('proadmin.single_title')}}</label>
				<div class="menu-item-input">
					<input v-model="single_item.title" class="form-control" placeholder="Single title (used for menu item)" type="text">
				</div>
			</div>
			<div class="form-group">
				<label class="menu-item-title">{{__('proadmin.single_name')}}</label>
				<div class="menu-item-input">
